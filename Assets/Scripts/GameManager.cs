...
public class GameManager : MonoBehaviour
{
    ...
    public PlayerManager PlayerManager { get { return m_player; } }

    List<EnemyManager> m_enemies;

    Turn m_currentTurn = Turn.Player;
    public Turn CurrentTurn { get { return m_currentTurn; } set { value = CurrentTurn; } }
    ...
    void Awake()
    {
        ...
        mainCanvas = Object.FindObjectOfType<Loader>().gameObject;
